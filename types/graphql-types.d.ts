...
export type SiteFieldsEnum = 
  ...
  | 'siteMetadata___copyrights'
  | 'siteMetadata___defaultTheme'
...
export type SiteSiteMetadata = {
  ...
  headerMenu?: Maybe<Array<Maybe<SiteSiteMetadataHeaderMenu>>>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  copyrights?: Maybe<StringQueryOperatorInput>;
  defaultTheme?: Maybe<StringQueryOperatorInput>;
  headerMenu?: Maybe<SiteSiteMetadataHeaderMenuFilterListInput>;
};

export type SiteSiteMetadataHeaderMenu = {
  title?: Maybe<Scalars['String']>;
  path?: Maybe<Scalars['String']>;
};

export type SiteSiteMetadataHeaderMenuFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  path?: Maybe<StringQueryOperatorInput>;
};

export type SiteSiteMetadataHeaderMenuFilterListInput = {
  elemMatch?: Maybe<SiteSiteMetadataHeaderMenuFilterInput>;
};
...
export type SiteTitleQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'blogTitle' | 'copyrights' | 'defaultTheme'>
      & { headerMenu?: Maybe<Array<Maybe<Pick<SiteSiteMetadataHeaderMenu, 'title' | 'path'>>>> }
    )> }> };
...
export type IndexQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'path' | 'tags'>> } }> } };

export type BlogArchivesQueryVariables = {
  limit: Scalars['Int'];
  skip: Scalars['Int'];
};


export type BlogArchivesQuery = { allMdx: { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'path' | 'tags'>> } }> } };
...
export type BlogTagArchivesQueryVariables = {
  tag: Scalars['String'];
};


export type BlogTagArchivesQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'id'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'path' | 'tags'>> }
      ) }> } };

export type BlogTagsQueryVariables = {};


export type BlogTagsQuery = { allMdx: { group: Array<(
      Pick<MdxGroupConnection, 'fieldValue' | 'totalCount'>
      & { edges: Array<{ node: { frontmatter?: Maybe<Pick<MdxFrontmatter, 'path' | 'title' | 'date'>> } }> }
    )> } };
